...
echo "Running rotation attack with crop percentage $CROP_PERCENTAGE on images in $IMG_DIR..."
python attacks.py $IMG_DIR --crop_factor $CROP_PERCENTAGE

## Step 2: Decode the watermarked images after the attack
echo "Decoding watermarked images after attack..."

KEY_PATH="keys/prc_num_500_steps_50_fpr_1e-05_nowm_0.pkl"
ATTACK_TYPE="crop_$CROP_PERCENTAGE"
