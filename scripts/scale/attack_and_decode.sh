...
echo "Running rescaling attack with on images in $IMG_DIR..."
python attacks.py $IMG_DIR --scale_factor $SCALE_FACTOR

## Step 2: Decode the watermarked images after the attack
echo "Decoding watermarked images after the attack..."

KEY_PATH="keys/prc_num_500_steps_50_fpr_1e-05_nowm_0.pkl"
ATTACK_TYPE="scale_$SCALE_FACTOR"
